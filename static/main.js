...
var MSP = (function (global, undefined) {
	...
	var toggleHelmetCheckbox = document.getElementById('toggleHelmet');

	toggleHelmetCheckbox.addEventListener('change', function () {
		isHelmet = toggleHelmetCheckbox.checked;
	});
